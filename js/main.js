...
var episodes = [0, 1, 1.1, 1.2, 1.3, 1.4, 1.5, 2, 2.1, 2.2, 2.3, 2.4, 3];
var totalData;
var dFirst;
...
var scaleX = d3.scaleLinear().domain([0, 14]).range([0, width]);
var scaleY = d3.scaleLinear().domain([0, 99]).range([0, height * 3]);
